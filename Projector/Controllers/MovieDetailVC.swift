...
class MovieDetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.accessibilityIdentifier = "movie-detail-view-controller"
        genreCollectionView.accessibilityIdentifier = "detail-genre-collection-view"
        castCollectionView.accessibilityIdentifier = "detail-cast-collection-view"
    ...
    @IBAction func bookmarkButtonClicked(_ sender: Any) {
        ...
        if let movieId = movieViewModel?.id {
            ...
            if let movie = coreDataManager.fetchMovie(movieId)  {
                ...
                bookmarkButton.accessibilityLabel = "bookmark-button-unselected"
            } else {
                coreDataManager.addNewMovie(movieId)
                bookmarkButton.setImage(UIImage(systemName: "bookmark.fill"), for: .normal)
                bookmarkButton.accessibilityLabel = "bookmark-button-selected"
            }
        }
...
extension MovieDetailVC: MovieViewModelDelegate {
    ...
    func updateUI() {
        ...
        self.ratingLabel.text = String(format:"%.1f", movieViewModel.rating)
        ...
        if coreDataManager.watchList.filter ({ $0.movieId == movieId }).count < 1 {
            ...
            self.bookmarkButton.accessibilityLabel = "bookmark-button-selected"
        }
