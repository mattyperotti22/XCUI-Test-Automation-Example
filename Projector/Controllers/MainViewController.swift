...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        fetchGenres()
        view.accessibilityIdentifier = "main-view-controller"
    }
    ...
    func configureNavBar() {
        ...
        navigationController?.navigationBar.topItem?.rightBarButtonItem?.accessibilityIdentifier = "search-button"
        navigationController?.navigationBar.accessibilityIdentifier = "nav-bar"
    ...
    func configureCollectionView() {
        ...
        genreCollectionView.accessibilityIdentifier = "genre-collection-view"
        headerCollectionView.accessibilityIdentifier = "header-collection-view"
